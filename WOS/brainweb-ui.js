  ...
  app = new Vue({
    ...
    data () {
      return {
        ...
        skills: ['abdominal', 'acquisition', 'aging', 'AI', 'analysis', 'angiography', 'artifacts', 'ASL', 'body', 'brain', 
        'breast', 'cancer', 'cardiovascular', 'CEST', 'coils', 'compressed sensing', 'connectivity', 'contrast agents', 
        'COVID-19', 'data curation', 'DCI', 'deep learning', 'denoising', 'diffusion', 'diversity', 'DTI', 'DWI', 'EEG', 
        'elastography', 'electron paramagnetic resonance', 'engineering', 'EPI', 'equality', 'ex-vivo', 'fat', 'fetus', 
        'fingerprinting', 'flow', 'fMRI', 'GAN', 'gradients', 'GRAPPA', 'gray matter', 'GRE', 'harmonization', 'HCP', 
        'hemodynamic', 'histology', 'hyperpolarized MR', 'image reconstruction', 'inclusivity', 'interventional', 'Linac', 
        'low rank', 'low-field', 'machine learning', 'magnetic particle imaging', 'magnets', 'MATLAB', 'metabolism', 
        'microscopy', 'modelling', 'molecular imaging', 'motion correction', 'MRI Together', 'MRS', 'MSK', 'MT', 
        'multi contrast', 'multi-site', 'multi-vendor', 'multiband', 'navigators', 'neonatal', 'NMR', 'open design', 
        'open hardware', 'open publishing', 'open review', 'open source', 'optimization', 'parallel imaging', 'parcellation', 
        'perfrusion', 'PET', 'phantoms', 'physics', 'physiology', 'population', 'post mortem', 'preclinical', 'primates', 
        'processing', 'pTX', 'public engagement', 'Python', 'quantitative imaging', 'relaxometry', 'RF', 'safety', 'SE', 
        'segmentation', 'SENSE', 'sequence design', 'shimming', 'signal preparation', 'silent', 'sparse', 
        'spatial encoding design', 'spinal cord', 'spiral', 'SSFP', 'structural', 'synthesis', 'T1', 'T2', 'T2*', 
        'trajectories', 'translational', 'UKB', 'ultrasound', 'VAE', 'vendor agnostic', 'wave-CAIPI', 'white matter', 'ZTE'],
