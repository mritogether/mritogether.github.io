...
2 - Each event has a html file in the same directory, to which is referred in the index.html under data-content. Those files contain the text in the modal when opened.
