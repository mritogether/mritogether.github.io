...
In 2026, MRI Together is becoming a **hackathon**: **MRI TogetherThon -  Refocusing the comminity**. The goal is to bring the community together around a shared, practical challenge — building a fully open-source, end-to-end MRI pipeline that benefits the entire field.
